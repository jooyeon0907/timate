...
public class CommonService {
	...
	public TodoItem getTotoItem(Long userId, Long calendarId, Long scheduleId, Long todoId) {
		validateCalendarMember(userId, calendarId);
		validateSchedule(calendarId, scheduleId);
		validateTodoItem(scheduleId, todoId);
		return todoItemRepository.findByIdAndScheduleId(todoId, scheduleId)
	...
	public void validateTodoItem(Long scheduleId, Long todoId) {
		if (!isTodoSchedule(scheduleId, todoId)) {
			throw new ScheduleException(TODO_NOT_FOUND);
		}
	}
	...
	public boolean isTodoSchedule(Long scheduleId, Long todoId) {
		return todoItemRepository.existsByIdAndScheduleId(todoId, scheduleId);
	}
